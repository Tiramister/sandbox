...
(meditations
 ...
 ;; キーワードの場合、(str :hoge) は ":hoge" になってしまう
 (= "world" (str 'world))
...
;; まとめ
;; 文字列はダブルクォートで囲む (シングルクォートで囲むとキーワードになる)
;; 文字はバックスラッシュを前に付ける
;; str 関数でキーワードを文字列に変換したり、文字列を連結できる
;; 文字列関連の関数は clojure.string 名前空間にある (初等的なものは clojure.core にある)

...
;; まとめ
;; マップのリテラルは {} で囲み、キーと値を交互に並べる
;; キーの型はキーワードでなくてもいい
;; マップを関数として使うことができ、キーを引数にして値を取得できる
;; 逆に、キーを関数として使い、マップを引数にして値を取得することもできる (正直キモい)
;; merge-with で、同じキーのエントリがあった場合のマージ方法を指定できる
;; map のコールバック関数は、キーと値が入ったベクタを引数に取る
